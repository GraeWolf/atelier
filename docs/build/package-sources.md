...
| Qt theme tools | `qt5ct`, `qt6ct` | void | Color schemes generated by `atelier-theme` |
| Wallpaper recolor | `gowall` | void | Depend of `atelier-config`; remaps stock wallpaper to the active palette |
| Palette from image | `matugen` | void | Depend of `atelier-desktop`; `atelier-theme from-wallpaper` |
